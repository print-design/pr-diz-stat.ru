                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            $sql = "select pem.last_name, pem.first_name, count(r.id) total, "
                                    ...
                                    . "where pw1.date = ped.date and pw1.shift = ped.shift and pw1.work_id = ped.work_id and pw1.machine_id = ped.machine_id and ped.work_id = ". WORK_CUTTING
                                    . " group by pem.id "
                                    . "order by total desc";
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = "select pem.last_name, pem.first_name, count(r.id) total, "
                                            ...
                                            . "pw1.date = ped.date and pw1.shift = ped.shift and pw1.work_id = ped.work_id and pw1.machine_id = ped.machine_id and ped.work_id = ". WORK_CUTTING
                                            . " group by pem.id "
                                            . "order by total desc";
                                    $fetcher = new Fetcher($sql);
