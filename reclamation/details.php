...
$sql = "select r.date, r.calculation_id, c.name calculation, r.defect_type, r.quantity, r.unit, r.percent, r.in_print, r.in_lamination, r.in_cut, r.comment "
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div><?=$date ?></div>
            <h1><?= $calculation ?></h1>
            <p><?= DEFECT_TYPE_NAMES[$defect_type] ?></p>
            <p><?=$quantity.' '. UNIT_NAMES[$unit].(empty($percent) ? '' : ' ('.$percent.'%)') ?></p>
